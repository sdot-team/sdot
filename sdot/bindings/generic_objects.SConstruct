...
construct( Environment, VariantDir, Configure, ARGLIST, "generic_objects", [], [
    'build/generic_objects_bindings.cpp',
    ...
    'build/cpp/sdot/symbolic/instructions/Alternative.cpp',
    'build/cpp/sdot/symbolic/instructions/LogicalAnd.cpp',
    'build/cpp/sdot/symbolic/instructions/LogicalOr.cpp',
    ...
    'build/cpp/sdot/symbolic/instructions/Ceil.cpp',
    'build/cpp/sdot/symbolic/instructions/Frac.cpp',
    'build/cpp/sdot/symbolic/instructions/Add.cpp',
    'build/cpp/sdot/symbolic/instructions/Mul.cpp',
    'build/cpp/sdot/symbolic/instructions/Cmp.cpp',
    'build/cpp/sdot/symbolic/instructions/axis.cpp',
