...
plt.plot( c.vertex_coords[ :, 0 ], c.vertex_coords[ :, 1 ], "x" )
# print( c.vertex_refs, c.bounded, c.true_dimensionality )
...
# plt.plot( c.vertex_coords[ :, 0 ], c.vertex_coords[ :, 1 ], "+" )
# print( c.vertex_refs, c.bounded, c.true_dimensionality )
# c.plot_in_pyplot( plt )

# c.cut( [ -0.13126000371532676, 0.16137033745074147 ], -0.02321846265965842 )

# plt.plot( c.vertex_coords[ :, 0 ] + .05, c.vertex_coords[ :, 1 ], "o" )
# print( c.vertex_refs, c.bounded, c.true_dimensionality )
# c.plot_in_pyplot( plt )
...
# plt.plot( c.vertex_coords[ :, 0 ] + 0.1, c.vertex_coords[ :, 1 ], "*" )
# c.plot_in_pyplot( plt )

# c.cut( [ -0.05034494939375456, 0.29159158045711475 ], 0.08475712496836402 )
# print( c.vertex_refs, c.bounded, c.true_dimensionality )

# plt.plot( c.vertex_coords[ :, 0 ] + 0.2, c.vertex_coords[ :, 1 ], "+" )
