...
auto concat( const AxisValues<TI,ct_rank_0,attributes_0...> &t0, const AxisValues<TI,ct_rank_1,attributes_1...> &t1 ) {
    using TR = AxisValues<TI,ct_rank_0+ct_rank_1,attributes_0...,typename WithOffset<int,ct_rank_0,attributes_1>::type...>;
...
#define DTP AxisValues<_TI,_ct_rank,ct_tail...>

UTP HD DTP::AxisValues( Function, auto &&func, auto index ) : front_value( func( index ) ), next_values( Function(), FORWARD( func ), index + Ct<int,1>() ) {
}

UTP HD DTP::AxisValues( Function, auto &&func ) : AxisValues( Function(), func, Ct<int,0>() ) {
}

UTP HD DTP::AxisValues( Values, TI front_value, auto... next_values ) : front_value( front_value ), next_values( Values(), next_values... ) {
}
...
UTP HD auto DTP::front_shape() const {
    return AxisValues<TI,1>( Values(), front_value );
}
...
UTP auto DTP::without_index( TI u ) const {
    using Res = AxisValues<TI,ct_rank-1>;
...
// // ---- compile-time front value (StaticAxisValue at offset 0) --------------------------
// #define UTP template<class _TI,class _Arch,int _ct_rank,_TI ct_front_value,class... ct_tail>
// #define DTP AxisValues<_TI,_Arch,_ct_rank,StaticAxisValue<_TI,0,ct_front_value>,ct_tail...>

// UTP HD DTP::AxisValues( Function, auto &&func, auto index ) : next_values( Function(), FORWARD( func ), index + Ct<int,1>() ) { ASSERT_EQ( func( index ), ct_front_value ); }
// UTP HD DTP::AxisValues( Function, auto &&func ) : AxisValues( Function(), func, Ct<int,0>() ) {}
// UTP HD DTP::AxisValues( Values, TI front_value, auto... next_values ) : next_values( Values(), next_values... ) { ASSERT_EQ( front_value, ct_front_value ); }
...
// UTP HD auto DTP::front_shape() const { return AxisValues<TI,Arch,1,StaticAxisValue<TI,0,ct_front_value>>( Values(), ct_front_value ); }
