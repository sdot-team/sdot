...
struct Cell {
    ...
    // info, computations --------------------------------------------------------------------
    HD void     for_each_facet_simplex ( auto &item_map, auto &&func ); ///< func( simplex_vertex_indices, cut_index ); cut_index into cut_planes/cut_ids; reuses item_map.next via generation trick
