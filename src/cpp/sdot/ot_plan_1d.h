...
T_T void ot_plan_1d_backward( TensorView<const T,2,Cpu> dirac_xs, TensorView<const T,1,Cpu> dirac_ws, auto &&primitive, TensorView<const T,2,Cpu> barycenters, TensorView<const T,1,Cpu> potentials, TensorView<const T,2,Cpu> cuts, TensorView<const T,0,Cpu> grad_distance, TensorView<const T,2,Cpu> grad_barycenters, TensorView<const T,1,Cpu> grad_potentials, TensorView<const T,2,Cpu> grad_cuts, TensorView<T,2,Cpu> grad_dirac_xs, TensorView<T,1,Cpu> grad_dirac_ws, TensorView<T,1,Cpu> grad_g_values );
