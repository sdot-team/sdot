...
template<class Shape,xla::ffi::DataType dtype,class MS>
auto tensor_view_inp( CtType<Shape>, const MS &memory_space, xla::ffi::Buffer<dtype> buf ) {
...
template<class Shape, xla::ffi::DataType dtype,class MS>
auto tensor_view_out( CtType<Shape> cs, const MS &memory_space, xla::ffi::ResultBuffer<dtype> buf ) {
...
template<class Shape, xla::ffi::DataType dtype,class MS>
auto tensor_view_mut( CtType<Shape> cs, const MS &memory_space, xla::ffi::ResultBuffer<dtype> buf_out, xla::ffi::Buffer<dtype> buf_inp ) {
...
template<class Shape, xla::ffi::DataType dtype,class MS>
auto dynamic_axis_inp( CtType<Shape> cs, const MS &memory_space, xla::ffi::Buffer<dtype> buf, PI num_dynamic_axis, PI capacity ) {
    return DynamicAxis{ num_dynamic_axis, capacity, tensor_view_inp( cs, memory_space, buf ) };
}

template<class Shape, xla::ffi::DataType dtype,class MS>
auto dynamic_axis_out( CtType<Shape> cs, const MS &memory_space, xla::ffi::ResultBuffer<dtype> buf, PI num_dynamic_axis, PI capacity ) {
...
template<class Shape, xla::ffi::DataType dtype,class MS>
auto dynamic_axis_mut( CtType<Shape> cs, const MS &memory_space, xla::ffi::Buffer<dtype> buf_inp, xla::ffi::ResultBuffer<dtype> buf_out, PI num_dynamic_axis, PI capacity ) {
