...
T_T void w2_distance( DiracSet<const T,0> diracs, Affine1d<const T,0> functions, TensorView<T,0> w2_squared, TensorView<T,1> w2_barycenters, TensorView<T,1> w2_potentials );
