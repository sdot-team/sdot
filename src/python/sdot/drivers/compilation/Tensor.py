...
class Tensor:
    ...
    @staticmethod
    def get_jax_ffi_args_for( jax_ffi_arg_list, driver, name, cpp_args, for_return, shape, dtype = None ):
        jax_ffi_arg_list._add_tensor_arg( driver, jax_ffi_arg_list._tensor_value( driver, shape, dtype, for_return ), name, cpp_args, for_return, valid = True )
