...
def get_or_create( module_name: str, output_specs ) -> jax_core.Primitive:
    ...
    The cache key includes output shapes so different capacities get distinct primitives.
    """
    cache_key = ( module_name, tuple( ( tuple( s.shape ), s.dtype ) for s in output_specs ) )
